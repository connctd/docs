...
Connectors can attach an arbitrary JSON object to communicate details about the installation state which may be used to communicate details about the installation state.
...
Connectors can attach an arbitrary JSON object to communicate details about the instance state which may be used to communicate detail about the instance state.
...
In case of an error the connctd platform will respond with status code **40x** or **50x** and a JSON object with details on the error is returned.
The **requestId** identifies this specific request and may be used to clarify unexpected errors with the connctd platform.
